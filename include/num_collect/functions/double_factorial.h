...
/*!
 * \file
 * \brief Definition of double_factorial function.
 */
#pragma once
...
/*!
 * \brief Calculate double factorial of n, \f$ n!! \f$.
 *
...
constexpr auto double_factorial(const Integer n) noexcept -> Result {

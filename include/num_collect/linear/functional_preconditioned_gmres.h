...
/*!
 * \file
 * \brief Definition of functional_preconditioned_gmres class.
 */
#pragma once
...
//! Log tag.
constexpr auto functional_preconditioned_gmres_tag = logging::log_tag_view(
    "num_collect::linear::functional_preconditioned_gmres");
 ...
 * coefficient matrix with preconditioning.
 *
...
class functional_preconditioned_gmres : public logging::logging_mixin {
public:
    //! Type of vectors.
    ...
    //! Constructor.
    functional_preconditioned_gmres()
        : logging::logging_mixin(functional_preconditioned_gmres_tag) {}
     ...
     * \return This.
     */
    auto max_iterations(index_type val) -> functional_preconditioned_gmres& {
     ...
     * \return This.
     */
    auto max_subspace_dim(index_type val) -> functional_preconditioned_gmres& {
     ...
     * \return This.
     */
    auto tolerance(scalar_type val) -> functional_preconditioned_gmres& {

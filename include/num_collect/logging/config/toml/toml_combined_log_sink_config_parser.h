...
/*!
 * \file
 * \brief Definition of toml_combined_log_sink_config_parser class.
 */
#pragma once
...
public:
    ...
    [[nodiscard]] auto parse(const ::toml::table& table)
        ...
        return std::make_shared<toml_combined_log_sink_factory>(table);
    }

    /*!
     * \brief Constructor.
     */
    toml_combined_log_sink_config_parser() noexcept = default;

    /*!
     * \brief Destructor.
     */
    ~toml_combined_log_sink_config_parser() noexcept override = default;

    toml_combined_log_sink_config_parser(
        const toml_combined_log_sink_config_parser&) = delete;
    toml_combined_log_sink_config_parser(
        toml_combined_log_sink_config_parser&&) = delete;
    auto operator=(const toml_combined_log_sink_config_parser&)
        -> toml_combined_log_sink_config_parser& = delete;
    auto operator=(toml_combined_log_sink_config_parser&&)
        -> toml_combined_log_sink_config_parser& = delete;
};

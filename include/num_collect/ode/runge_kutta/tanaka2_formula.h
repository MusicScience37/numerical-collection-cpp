...
/*!
 * \brief Class of Tanaka Formula 2 \cite Togawa2007.
 *
...
/*!
 * \brief Class of solver using Tanaka Formula 2 with adaptive step sizes.
 *
 * \tparam Problem Type of problem.
 */
template <concepts::problem Problem>
using tanaka2_adaptive_step_solver =
    adaptive_step_solver<tanaka2_formula<Problem>>;

...
/*!
 * \file
 * \brief Definition of esdirk45_formula class.
 */
#pragma once
...
/*!
 * \brief Class of ESDIRK45c formula in \cite Jorgensen2018.
 *
...
class esdirk45_formula
    : public implicit_formula_base<esdirk45_formula<Problem, FormulaSolver>,
...
public:
    ...
    //! Type of base class.
    using base_type =
        implicit_formula_base<esdirk45_formula<Problem, FormulaSolver>, Problem,
            FormulaSolver>;
...
/*!
 * \brief Class of solver using ESDIRK45c formula in \cite Jorgensen2018 with
 * adaptive step sizes.
 *
 * \tparam Problem Type of problem.
 */
template <concepts::problem Problem>
using esdirk45_adaptive_step_solver =
    adaptive_step_solver<esdirk45_formula<Problem>>;

...
class ros34pw3_formula
    : public rosenbrock_formula_base<ros34pw3_formula<Problem, EquationSolver>,
          Problem, EquationSolver> {
public:
    //! Type of base class.
    using base_type =
        rosenbrock_formula_base<ros34pw3_formula<Problem, EquationSolver>,
            Problem, EquationSolver>;
...
public:
     ...
     */
    explicit ros34pw3_formula(const problem_type& problem)
        : base_type(problem, g) {}
...
/*!
 * \brief Class of solver using ROS34PW3 formula in \cite Rang2005 with adaptive
 * step sizes.
 *
 * \tparam Problem Type of problem.
 */
template <concepts::problem Problem>
using ros34pw3_adaptive_step_solver =
    adaptive_step_solver<ros34pw3_formula<Problem>>;

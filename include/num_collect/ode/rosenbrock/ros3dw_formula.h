...
/*!
 * \file
 * \brief Definition of ros3dw_formula class.
 */
#pragma once
...
/*!
 * \brief Class of ROS3Dw formula in \cite Rang2005 for Rosenbrock method.
 *
...
class ros3dw_formula
    : public rosenbrock_formula_base<ros3dw_formula<Problem, EquationSolver>,
          Problem, EquationSolver> {
public:
    //! Type of base class.
    using base_type =
        rosenbrock_formula_base<ros3dw_formula<Problem, EquationSolver>,
            Problem, EquationSolver>;
...
public:
    ...
    static constexpr auto log_tag =
        logging::log_tag_view("num_collect::ode::rosenbrock::ros3dw_formula");
    ...
    static constexpr scalar_type a31 = coeff(3.8213294371763229e-01);
    ...
    static constexpr scalar_type g21 = coeff(4.7532138161945031e-01);
    static constexpr scalar_type g31 = coeff(-9.7712149572940343e-01);
    static constexpr scalar_type g32 = coeff(-1.0731056295754648e-01);
    ...
    static constexpr scalar_type c1 = coeff(1.1863142804796199e-01);
    static constexpr scalar_type c2 = coeff(3.3333333333333333e-01);
    static constexpr scalar_type c3 = coeff(5.4803523861870473e-01);

    static constexpr scalar_type cw1 = coeff(3.6180340134778349e-01);
    static constexpr scalar_type cw2 = coeff(2.5000000000000000e-01);
    static constexpr scalar_type cw3 = coeff(3.8819659865221651e-01);
     ...
     */
    explicit ros3dw_formula(const problem_type& problem)
        : base_type(problem, g) {}
    ...
    void step_embedded(scalar_type time, scalar_type step_size,
        ...
        equation_solver().apply_jacobian(temp_var_, temp_rhs_);
        temp_rhs_ *= step_size;
        temp_var_ = current + step_size * (a31 * k1_);
...
/*!
 * \brief Class of solver using ROS3Dw formula in \cite Rang2005 with adaptive
 * step sizes.
 *
 * \tparam Problem Type of problem.
 */
template <concepts::problem Problem>
using ros3dw_adaptive_step_solver =
    adaptive_step_solver<ros3dw_formula<Problem>>;

...
/*!
 * \file
 * \brief Definition of ros3prl2_formula class.
 */
#pragma once
...
/*!
 * \brief Class of ROS3PRL2 formula in \cite Rang2015 for Rosenbrock method.
 *
...
class ros3prl2_formula
    : public rosenbrock_formula_base<ros3prl2_formula<Problem, EquationSolver>,
          Problem, EquationSolver> {
public:
    //! Type of base class.
    using base_type =
        rosenbrock_formula_base<ros3prl2_formula<Problem, EquationSolver>,
            Problem, EquationSolver>;
...
public:
    ...
    static constexpr auto log_tag =
        logging::log_tag_view("num_collect::ode::rosenbrock::ros3prl2_formula");
    ...
    static constexpr scalar_type a21 = coeff(1.3075995645253771e+00);
    static constexpr scalar_type a31 = coeff(5.0000000000000000e-01);
    static constexpr scalar_type a32 = coeff(5.0000000000000000e-01);
    static constexpr scalar_type a41 = coeff(5.0000000000000000e-01);
    ...
    static constexpr scalar_type b4 = a41 + a42;

    static constexpr scalar_type g21 = coeff(-1.3075995645253771e+00);
    static constexpr scalar_type g31 = coeff(-7.0988575860972170e-01);
    static constexpr scalar_type g32 = coeff(-5.5996735960277766e-01);
    static constexpr scalar_type g41 = coeff(-1.5550856807552085e-01);
    static constexpr scalar_type g42 = coeff(-9.5388516575112225e-01);
    static constexpr scalar_type g43 = coeff(6.7352721231818413e-01);
    ...
    static constexpr scalar_type c1 = coeff(3.4449143192447917e-01);
    static constexpr scalar_type c2 = coeff(-4.5388516575112231e-01);
    static constexpr scalar_type c3 = coeff(6.7352721231818413e-01);
    static constexpr scalar_type c4 = coeff(4.3586652150845900e-01);

    static constexpr scalar_type cw1 = coeff(5.0000000000000000e-01);
    static constexpr scalar_type cw2 = coeff(-2.5738812086522078e-01);
    static constexpr scalar_type cw3 = coeff(4.3542008724775044e-01);
     ...
     */
    explicit ros3prl2_formula(const problem_type& problem)
        : base_type(problem, g) {}
    ...
    void step_embedded(scalar_type time, scalar_type step_size,
        ...
        equation_solver().apply_jacobian(temp_var_, temp_rhs_);
        temp_rhs_ *= step_size;
        temp_var_ = current + step_size * (a41 * k1_ + a42 * k2_);
...
/*!
 * \brief Class of solver using ROS3PRL2 formula in \cite Rang2015 with adaptive
 * step sizes.
 *
 * \tparam Problem Type of problem.
 */
template <concepts::problem Problem>
using ros3prl2_adaptive_step_solver =
    adaptive_step_solver<ros3prl2_formula<Problem>>;

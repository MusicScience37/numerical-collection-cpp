...
/*!
 * \file
 * \brief Example of CT simulation using tv_admm class.
 */
#include <string>
...
auto main(int argc, char** argv) -> int {
    ...
    solver_type solver;
    solver.compute(coeff, derivative_matrix, data);
    ...
    visualize_result(origin, solution, "TV Regularization", "tv_admm");

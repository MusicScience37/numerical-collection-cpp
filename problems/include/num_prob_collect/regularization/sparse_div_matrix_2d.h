...
/*!
 * \file
 * \brief Definition of sparse_div_matrix_2d function.
 */
#pragma once
...
/*!
 * \brief Create a sparse matrix for 2D divergence.
 *
 * This matrix is used to compute the second derivative from the first
 * derivative calculated using the matrix generated by `sparse_diff_matrix_2d`.
 *
...
/*!
 * \brief Create a sparse matrix for 2D divergence with boundaries.
 *
 * This matrix is used to compute the second derivative from the first
 * derivative calculated using the matrix generated by `sparse_diff_matrix_2d`.
 *

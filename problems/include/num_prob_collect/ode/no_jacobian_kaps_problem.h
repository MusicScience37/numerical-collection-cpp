...
/*!
 * \file
 * \brief Definition of no_jacobian_kaps_problem class.
 */
#pragma once
...
/*!
 * \brief Class of Kaps' problem \cite Kennedy2003 without Jacobian.
 *
 ...
 */
class no_jacobian_kaps_problem {
public:
    //! Type of variables.
     ...
     */
    explicit no_jacobian_kaps_problem(double epsilon) : epsilon_(epsilon) {}

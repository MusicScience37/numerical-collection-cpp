...
/*!
 * \file
 * \brief Definition of no_jacobian_implicit_kaps_problem class.
 */
#pragma once
...
/*!
 * \brief Class of Kaps' problem \cite Kennedy2003 without Jacobian matrix.
 *
...
public:
     ...
     */
    explicit no_jacobian_implicit_kaps_problem(double epsilon)
...
static_assert(num_collect::ode::concepts::multi_variate_problem<

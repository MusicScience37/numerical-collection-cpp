...
/*!
 * \file
 * \brief Definition of no_jacobian_linear_first_order_dae_problem class.
 */
#pragma once
...
/*!
 * \brief Class of linear first-order DAE problems without Jacobian.
 *
...
template <num_collect::base::concepts::real_scalar_dense_vector Vector,
    ...
    num_collect::base::concepts::sparse_matrix_of<Matrix,
        typename Vector::value_type>
class no_jacobian_linear_first_order_dae_problem {
public:
    //! Type of vectors.
     ...
     */
    no_jacobian_linear_first_order_dae_problem(const mass_type& mass_matrix,

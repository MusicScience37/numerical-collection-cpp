...
TEMPLATE_PRODUCT_TEST_CASE("exponential_problem with non-embedded formulas", "",
    (num_collect::ode::runge_kutta::implicit_euler_fixed_step_solver,
        ...
        num_collect::ode::runge_kutta::lobatto3c4_fixed_step_solver,
        num_collect::ode::runge_kutta::lobatto3c6_fixed_step_solver,
        num_collect::ode::runge_kutta::radau2a3_fixed_step_solver,
        num_collect::ode::runge_kutta::radau2a5_fixed_step_solver,
        num_collect::ode::runge_kutta::radau2a7_fixed_step_solver,
        num_collect::ode::runge_kutta::radau2a9_fixed_step_solver,
        num_collect::ode::runge_kutta::radau2a11_fixed_step_solver,
        num_collect::ode::runge_kutta::radau2a13_fixed_step_solver,
        num_collect::ode::runge_kutta::radau2a15_fixed_step_solver,
        num_collect::ode::runge_kutta::radau2a17_fixed_step_solver),

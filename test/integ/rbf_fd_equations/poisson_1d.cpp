...
/*!
 * \file
 * \brief Test to solve 1D Poisson equation.
 */
#include <cmath>
...
TEST_CASE("Poisson equation in 1D") {
...
#ifndef NDEBUG
    const num_collect::index_type num_interior_nodes = 100;
#else
    const num_collect::index_type num_interior_nodes = 1000;
#endif

...
def test_async_trace_log(
    ...
    _verify_command_result(
        writer_path=writer_path,
        config_file_path=config_dir_path / "async_file_log_trace.toml",
        test_temp_dir_path=test_temp_dir_path,
        log_path=test_temp_dir_path / "num_collect_test_integ_logging.log",
    )


def test_async_queue_full(
    ...
    _verify_command_result(
        writer_path=build_dir_path
        / "bin"
        / "num_collect_test_integ_logging_write_log_writer_async_queue_full",
        config_file_path=config_dir_path / "async_file_log_trace.toml",
        test_temp_dir_path=test_temp_dir_path,
        log_path=test_temp_dir_path / "num_collect_test_integ_logging.log",
    )

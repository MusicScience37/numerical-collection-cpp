...
TEST_CASE("num_collect::util::trivial_vector") {
    ...
    SECTION("insert a range at the end using iterators") {
        trivial_vector<int> vector{1, 2, 3};
    ...
    SECTION("insert a range in the middle using iterators") {
        trivial_vector<int> vector{1, 2, 3};
        const trivial_vector<int> source{4, 5};
    ...
    SECTION("insert an empty range using iterators") {
        trivial_vector<int> vector{1, 2, 3};
    ...
    SECTION("insert a range at the end using ranges") {
        trivial_vector<int> vector{1, 2, 3};
        const trivial_vector<int> source{4, 5};

        auto iter = vector.insert_range(vector.end(), source);
    ...
    SECTION("insert a range in the middle using ranges") {
        trivial_vector<int> vector{1, 2, 3};
        const trivial_vector<int> source{4, 5};

        auto iter = vector.insert_range(vector.begin() + 1, source);
    ...
    SECTION("insert an empty range using ranges") {
        trivial_vector<int> vector{1, 2, 3};
        const trivial_vector<int> source{};
    ...
    SECTION("append a range") {
        trivial_vector<int> vector{1, 2, 3};
        const trivial_vector<int> source{4, 5};

        vector.append_range(source);

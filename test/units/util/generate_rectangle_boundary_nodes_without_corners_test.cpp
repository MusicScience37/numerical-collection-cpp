...
/*!
 * \file
 * \brief Test of generate_rectangle_boundary_nodes_without_corners function.
 */
...
TEMPLATE_TEST_CASE(
    ...
    using num_collect::util::generate_rectangle_boundary_nodes_without_corners;
    ...
    SECTION("counter-clockwise (default) with num_nodes_per_edge = 4") {
        ...
        CHECK_THAT(nodes[3].x(),
            Catch::Matchers::WithinAbs(
                static_cast<scalar_type>(1.75), approx_eps));
        CHECK_THAT(nodes[3].y(),
            Catch::Matchers::WithinAbs(
                static_cast<scalar_type>(0), approx_eps));

        // Right edge: (2,0.375), (2,1.125), (2,1.875), (2,2.625)
        CHECK_THAT(nodes[4].x(),
            Catch::Matchers::WithinAbs(
                static_cast<scalar_type>(2), approx_eps));
        CHECK_THAT(nodes[4].y(),
            Catch::Matchers::WithinAbs(
                static_cast<scalar_type>(0.375), approx_eps));
        CHECK_THAT(nodes[5].x(),
            Catch::Matchers::WithinAbs(
                static_cast<scalar_type>(2), approx_eps));
        CHECK_THAT(nodes[5].y(),
            Catch::Matchers::WithinAbs(
                static_cast<scalar_type>(1.125), approx_eps));

        // Top edge: (1.75,3), (1.25,3), (0.75,3), (0.25,3)
        ...
        CHECK_THAT(nodes[9].x(),
            Catch::Matchers::WithinAbs(
                static_cast<scalar_type>(1.25), approx_eps));
        CHECK_THAT(nodes[9].y(),
            Catch::Matchers::WithinAbs(
                static_cast<scalar_type>(3), approx_eps));

        // Left edge: (0,2.625), (0,1.875), (0,1.125), (0,0.375)
        CHECK_THAT(nodes[12].x(),
            Catch::Matchers::WithinAbs(
                static_cast<scalar_type>(0), approx_eps));
        CHECK_THAT(nodes[12].y(),
            Catch::Matchers::WithinAbs(
                static_cast<scalar_type>(2.625), approx_eps));
    ...
    SECTION("clockwise with num_nodes_per_edge = 4") {
        ...
        // Left-up edge: (0,0.375), (0,1.125), (0,1.875), (0,2.625)
        CHECK_THAT(nodes[0].x(),
            Catch::Matchers::WithinAbs(
                static_cast<scalar_type>(0), approx_eps));
        CHECK_THAT(nodes[0].y(),
        ...
        // Top-right edge: (0.25,3), (0.75,3), (1.25,3), (1.75,3)
        CHECK_THAT(nodes[4].x(),
            Catch::Matchers::WithinAbs(
                static_cast<scalar_type>(0.25), approx_eps));
        CHECK_THAT(nodes[4].y(),
        ...
        // Right-down edge: (2,2.625), (2,1.875), (2,1.125), (2,0.375)
        CHECK_THAT(nodes[8].x(),
            Catch::Matchers::WithinAbs(
                static_cast<scalar_type>(2), approx_eps));
        CHECK_THAT(nodes[8].y(),
        ...
        CHECK_THAT(nodes[9].y(),
            Catch::Matchers::WithinAbs(
                static_cast<scalar_type>(1.875), approx_eps));

        // Bottom-left edge: (1.75,0), (1.25,0), (0.75,0), (0.25,0)
        CHECK_THAT(nodes[12].x(),
            Catch::Matchers::WithinAbs(
                static_cast<scalar_type>(1.75), approx_eps));
        CHECK_THAT(nodes[12].y(),
    ...
    SECTION("num_nodes_per_edge = 1") {
        ...
        CHECK_THAT(nodes[0].x(),
            Catch::Matchers::WithinAbs(
                static_cast<scalar_type>(1), approx_eps));
        CHECK_THAT(nodes[0].y(),
            Catch::Matchers::WithinAbs(
                static_cast<scalar_type>(0), approx_eps));

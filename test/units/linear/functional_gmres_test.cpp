...
/*!
 * \file
 * \brief Test of functional_gmres class.
 */
...
TEST_CASE("num_collect::linear::functional_gmres") {
    using num_collect::linear::functional_gmres;
    ...
    SECTION("solve") {
        ...
        functional_gmres<Eigen::Vector3d> solver;
    ...
    SECTION("set maximum number of iterations") {
        functional_gmres<Eigen::VectorXd> solver;

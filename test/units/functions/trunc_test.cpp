...
TEMPLATE_TEST_CASE(
    "num_collect::functions::impl::trunc_at_compile_time", "", float, double) {
    SECTION("x = -2") {
        CHECK_CONSTEXPR_FUNCTION_EQUAL((static_cast<TestType>(-2.0)),
            num_collect::functions::impl::trunc_at_compile_time, std::trunc);
    }
...
TEMPLATE_TEST_CASE("num_collect::functions::trunc", "", float, double) {
    SECTION("x = -2") {
        CHECK_CONSTEXPR_FUNCTION_EQUAL((static_cast<TestType>(-2.0)),
            num_collect::functions::trunc, std::trunc);
    }

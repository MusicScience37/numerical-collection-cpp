...
/*!
 * \file
 * \brief Test of ceil function.
 */
#include "num_collect/functions/ceil.h"
...
TEMPLATE_TEST_CASE(
    "num_collect::functions::impl::ceil_at_compile_time", "", float, double) {
    SECTION("x = -2") {
        CHECK_CONSTEXPR_FUNCTION_EQUAL((static_cast<TestType>(-2.0)),
            num_collect::functions::impl::ceil_at_compile_time, std::ceil);
    }
...
TEMPLATE_TEST_CASE("num_collect::functions::ceil", "", float, double) {
    SECTION("x = -2") {
        CHECK_CONSTEXPR_FUNCTION_EQUAL((static_cast<TestType>(-2.0)),
            num_collect::functions::ceil, std::ceil);
    }

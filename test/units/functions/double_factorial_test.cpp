 ...
 */
#include "num_collect/functions/double_factorial.h"
...
TEMPLATE_TEST_CASE_SIG("num_collect::functions::double_factorial", "",
    ...
    SECTION("n = 0") {
        CHECK_CONSTEXPR_FUNCTION_EQUAL((static_cast<Integer>(0)),
            num_collect::functions::double_factorial<Result>,
    ...
    SECTION("n = 3") {
        CHECK_CONSTEXPR_FUNCTION_EQUAL((static_cast<Integer>(3)),
            num_collect::functions::double_factorial<Result>,
            [](Integer /*input*/) -> Result { return static_cast<Result>(3); });
    }

    SECTION("n = 4") {
        CHECK_CONSTEXPR_FUNCTION_EQUAL((static_cast<Integer>(4)),
            num_collect::functions::double_factorial<Result>,
            [](Integer /*input*/) -> Result { return static_cast<Result>(8); });
    }
    ...
    SECTION("n = -1") {
        if constexpr (std::signed_integral<Integer>) {
            ...
            constexpr auto value_at_compile_time =
                num_collect::functions::double_factorial<Result>(n);

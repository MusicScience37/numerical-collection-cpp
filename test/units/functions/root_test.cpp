...
TEMPLATE_TEST_CASE(
    "num_collect::functions::impl::root_at_compile_time", "", float, double) {
    ...
    SECTION("x < 0, n is even") {
        ...
        SECTION("n = 2") {
            ...
            constexpr TestType value_at_compile_time =
                num_collect::functions::impl::root_at_compile_time(x, n);
    ...
    SECTION("x < 0, n is odd") {
        ...
        SECTION("n = 3") {
            CHECK_CONSTEXPR_FUNCTION_RELATIVE((x, static_cast<int>(3)),
                num_collect::functions::impl::root_at_compile_time,
                reference_function);
        }
        SECTION("n = 5") {
...
TEMPLATE_TEST_CASE("num_collect::functions::root", "", float, double) {
    const auto reference_function = [](TestType x, int n) -> TestType {
        if (x < static_cast<TestType>(0)) {
            return -static_cast<TestType>(std::pow(
                -static_cast<double>(x), 1.0 / static_cast<double>(n)));
    ...
    SECTION("x < 0, n is even") {
        ...
        SECTION("n = 2") {
            constexpr auto n = 2;
            constexpr TestType value_at_compile_time =
                num_collect::functions::root(x, n);
            const TestType value_runtime = num_collect::functions::root(x, n);
            CHECK(std::isnan(value_at_compile_time));
            CHECK(std::isnan(value_runtime));
        }
        SECTION("n = 4") {
    ...
    SECTION("x < 0, n is odd") {
        ...
        SECTION("n = 3") {
            CHECK_CONSTEXPR_FUNCTION_RELATIVE((x, static_cast<int>(3)),
                num_collect::functions::root, reference_function);
        }
        SECTION("n = 5") {
            CHECK_CONSTEXPR_FUNCTION_RELATIVE((x, static_cast<int>(5)),
                num_collect::functions::root, reference_function);
...
TEMPLATE_TEST_CASE(
    "num_collect::functions::root (integers)", "", int, long long) {
    ...
    SECTION("x < 0, n is even") {
        ...
        SECTION("n = 2") {
            ...
            constexpr double value_at_compile_time =
                num_collect::functions::root(x, n);
            const double value_runtime = num_collect::functions::root(x, n);
            CHECK(std::isnan(value_at_compile_time));
            CHECK(std::isnan(value_runtime));
        }
        SECTION("n = 4") {

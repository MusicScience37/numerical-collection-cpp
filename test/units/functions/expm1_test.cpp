...
TEMPLATE_TEST_CASE(
    "num_collect::functions::impl::expm1_at_compile_time", "", float, double) {
    SECTION("negative number") {
        CHECK_CONSTEXPR_FUNCTION_RELATIVE((static_cast<TestType>(-0.123)),
            num_collect::functions::impl::expm1_at_compile_time, std::expm1);
    }
...
TEMPLATE_TEST_CASE("num_collect::functions::expm1", "", float, double) {
    SECTION("negative number") {
        CHECK_CONSTEXPR_FUNCTION_RELATIVE((static_cast<TestType>(-0.123)),
            num_collect::functions::expm1, std::expm1);
    }

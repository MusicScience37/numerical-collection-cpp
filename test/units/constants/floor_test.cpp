...
// NOLINTNEXTLINE
TEMPLATE_TEST_CASE(
    "num_collect::constants::impl::floor_at_compile_time", "", float, double) {
    SECTION("x = -2") {
        CHECK_CONSTEXPR_FUNCTION_EQUAL((static_cast<TestType>(-2.0)),
            num_collect::constants::impl::floor_at_compile_time, std::floor);
    }
...
TEMPLATE_TEST_CASE("num_collect::constants::floor", "", float, double) {
    SECTION("x = -2") {
        CHECK_CONSTEXPR_FUNCTION_EQUAL((static_cast<TestType>(-2.0)),
            num_collect::constants::floor, std::floor);
    }

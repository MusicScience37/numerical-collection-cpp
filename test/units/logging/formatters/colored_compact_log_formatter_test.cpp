...
/*!
 * \file
 * \brief Test of colored_compact_log_formatter class.
 */
...
TEST_CASE("num_collect::logging::formatters::colored_compact_log_formatter") {
    ...
    using num_collect::logging::formatters::colored_compact_log_formatter;
    using num_collect::util::source_info_view;

    colored_compact_log_formatter formatter{};

...
/*!
 * \file
 * \brief Test of detailed_log_formatter class.
 */
...
TEST_CASE("num_collect::logging::formatters::detailed_log_formatter") {
    using num_collect::index_type;
    using num_collect::logging::log_level;
    using num_collect::logging::formatters::detailed_log_formatter;

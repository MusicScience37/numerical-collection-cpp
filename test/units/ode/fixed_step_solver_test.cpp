...
/*!
 * \file
 * \brief Test of fixed_step_solver_test class.
 */
...
TEST_CASE(
    "num_collect::ode::fixed_step_solver<num_collect::ode::runge_"
    ...
    using solver_type = num_collect::ode::fixed_step_solver<formula_type>;

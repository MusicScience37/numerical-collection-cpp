...
/*!
 * \file
 * \brief Test of ros3prl2_formula class.
 */
...
TEST_CASE("num_collect::ode::rosenbrock::ros3prl2_formula") {
    using problem_type = num_prob_collect::ode::exponential_problem;
    using formula_type =
        num_collect::ode::rosenbrock::ros3prl2_formula<problem_type>;
    ...
    SECTION("static definition") {
        ...
        CHECK_THAT(formula_type::a41 + formula_type::a42,

...
TEST_CASE("num_collect::ode::runge_kutta::ark43_esdirk_formula") {
    using problem_type = num_prob_collect::ode::exponential_problem;
    using formula_type =
        num_collect::ode::runge_kutta::ark43_esdirk_formula<problem_type>;
...
TEST_CASE(
    "num_collect::ode::runge_kutta::ark43_esdirk_solver<num_prob_collect::ode::"
    "exponential_problem>") {
    using problem_type = num_prob_collect::ode::exponential_problem;
    using solver_type =

...
/*!
 * \file
 * \brief Test of lobatto3c4_formula class.
 */
...
TEST_CASE("num_collect::ode::runge_kutta::lobatto3c4_formula") {
    using num_collect::ode::runge_kutta::lobatto3c4_formula;

    SECTION("static definition") {
        using problem_type = num_prob_collect::ode::exponential_problem;
        using formula_type = lobatto3c4_formula<problem_type>;

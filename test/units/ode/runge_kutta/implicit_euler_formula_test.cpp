...
TEST_CASE(
    "num_collect::ode::runge_kutta::implicit_euler_solver<num_prob_collect::"
    "ode::exponential_problem>") {
    using problem_type = num_prob_collect::ode::exponential_problem;
    using solver_type =
        num_collect::ode::runge_kutta::implicit_euler_solver<problem_type>;
...
TEST_CASE(
    "num_collect::ode::runge_kutta::implicit_euler_solver<num_prob_collect::"
    "ode::external_force_vibration_problem>") {
    using problem_type =

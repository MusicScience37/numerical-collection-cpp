...
TEST_CASE("num_collect::ode::runge_kutta::radau2a5_changing_mass_formula") {
    using num_collect::ode::runge_kutta::radau2a5_changing_mass_formula;

    SECTION("static definition") {
        using problem_type = num_prob_collect::ode::exponential_problem;
        using formula_type = radau2a5_changing_mass_formula<problem_type>;

...
/*!
 * \file
 * \brief Test of ark43_erk_formula class.
 */
...
TEST_CASE("num_collect::ode::runge_kutta::ark43_erk_formula") {
    using problem_type = num_prob_collect::ode::exponential_problem;
    using formula_type =
        num_collect::ode::runge_kutta::ark43_erk_formula<problem_type>;
    ...
    SECTION("static definition") {
        ...
        CHECK_THAT(formula_type::cw1 + formula_type::cw3 + formula_type::cw4 +
                formula_type::cw5 + formula_type::cw6,
            Catch::Matchers::WithinRel(1.0));
...
TEST_CASE(
    "num_collect::ode::runge_kutta::ark43_erk_solver<num_prob_collect::ode::"
    "exponential_problem>") {
    using problem_type = num_prob_collect::ode::exponential_problem;
    using solver_type =

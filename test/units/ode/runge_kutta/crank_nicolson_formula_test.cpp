...
/*!
 * \file
 * \brief Test of crank_nicolson_formula class.
 */
...
TEST_CASE("num_collect::ode::runge_kutta::crank_nicolson_formula") {
    using problem_type = num_prob_collect::ode::exponential_problem;
    using formula_type =
        num_collect::ode::runge_kutta::crank_nicolson_formula<problem_type>;

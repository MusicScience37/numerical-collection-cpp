...
/*!
 * \file
 * \brief Test of lobatto3c6_formula class.
 */
...
TEST_CASE("num_collect::ode::runge_kutta::lobatto3c6_formula") {
    using num_collect::ode::runge_kutta::lobatto3c6_formula;

    SECTION("static definition") {
        using problem_type = num_prob_collect::ode::exponential_problem;
        using formula_type = lobatto3c6_formula<problem_type>;
    ...
    SECTION("check coefficients") {
        ...
        CHECK_THAT(slope_coeffs.row(3).sum(),
            Catch::Matchers::WithinRel(time_coeffs(3)));

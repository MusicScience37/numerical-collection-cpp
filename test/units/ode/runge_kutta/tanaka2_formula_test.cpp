...
/*!
 * \file
 * \brief Test of tanaka2_formula class.
 */
...
TEST_CASE("num_collect::ode::runge_kutta::tanaka2_formula") {
    ...
    SECTION("static definition") {
        ...
        CHECK_THAT(formula_type::a31 + formula_type::a32 + formula_type::a33,
        ...
        CHECK_THAT(formula_type::cw2, Catch::Matchers::WithinRel(1.0));
...
TEST_CASE(
    "num_collect::ode::runge_kutta::tanaka2_solver<num_prob_collect::ode::"
    "exponential_problem>") {
    using problem_type = num_prob_collect::ode::exponential_problem;
    using solver_type =

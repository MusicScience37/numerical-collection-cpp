...
#include "exact_rbf_interpolator_test.cpp"  // NOLINT(bugprone-suspicious-include)
...
#include "symmetric_kernel_matrix_solver_test.cpp"  // NOLINT(bugprone-suspicious-include)

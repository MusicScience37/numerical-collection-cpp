...
/*!
 * \file
 * \brief Test of local_exact_rbf_interpolator class.
 */
...
TEST_CASE("num_collect::rbf::local_exact_rbf_interpolator") {
    using num_collect::rbf::local_exact_rbf_interpolator;
    using num_collect::rbf::rbfs::gaussian_rbf;

    using variable_type = double;
    using rbf_interpolator_type = local_exact_rbf_interpolator<variable_type>;

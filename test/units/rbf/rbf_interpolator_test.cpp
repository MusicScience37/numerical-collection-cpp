...
/*!
 * \file
 * \brief Test of rbf_interpolator class.
 */
...
TEST_CASE("num_collect::rbf::local_rbf_interpolator") {
    ...
    using rbf_interpolator_type = local_rbf_interpolator<double(double)>;
...
TEST_CASE("num_collect::rbf::global_rbf_interpolator") {
...
TEST_CASE("num_collect::rbf::local_csrbf_interpolator") {

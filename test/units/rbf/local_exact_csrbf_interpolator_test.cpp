...
/*!
 * \file
 * \brief Test of local_exact_csrbf_interpolator class.
 */
...
TEST_CASE("num_collect::rbf::local_exact_csrbf_interpolator") {
    using num_collect::rbf::local_exact_csrbf_interpolator;

    using variable_type = double;
    using rbf_interpolator_type = local_exact_csrbf_interpolator<variable_type>;

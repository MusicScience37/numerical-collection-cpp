...
/*!
 * \file
 * \brief Test of global_length_parameter_calculator class.
 */
...
TEST_CASE("num_collect::rbf::rbfs::global_length_parameter_calculator") {
    ...
    SECTION("compute the length parameter") {
        ...
        constexpr double length_parameter = 0.6;
        CHECK_THAT(calculator.length_parameter_at(0),
            Catch::Matchers::WithinRel(length_parameter));
    }

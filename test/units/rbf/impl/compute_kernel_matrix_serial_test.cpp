...
/*!
 * \file
 * \brief Test of compute_kernel_matrix_serial function.
 */
...
TEST_CASE("num_collect::rbf::impl::compute_kernel_matrix_serial") {
    using num_collect::rbf::distance_functions::euclidean_distance_function;
    using num_collect::rbf::impl::compute_kernel_matrix_serial;

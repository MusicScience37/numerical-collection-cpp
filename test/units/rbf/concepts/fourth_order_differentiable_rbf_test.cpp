...
/*!
 * \file
 * \brief Test of fourth_order_differentiable_rbf concept.
 */
...
TEST_CASE("num_collect::rbf::concepts::fourth_order_differentiable_rbf") {
    using num_collect::rbf::concepts::fourth_order_differentiable_rbf;
    using num_collect::rbf::rbfs::differentiated_t;

    SECTION("check RBFs") {
        STATIC_REQUIRE(fourth_order_differentiable_rbf<
            num_collect::rbf::rbfs::gaussian_rbf<double>>);
        STATIC_REQUIRE_FALSE(fourth_order_differentiable_rbf<
        ...
        STATIC_REQUIRE_FALSE(fourth_order_differentiable_rbf<differentiated_t<
                num_collect::rbf::rbfs::wendland_csrbf<double, 2, 0>>>);
    }
}

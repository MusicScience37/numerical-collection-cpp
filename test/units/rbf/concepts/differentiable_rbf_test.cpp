...
/*!
 * \file
 * \brief Test of differentiable_rbf concept.
 */
...
TEST_CASE("num_collect::rbf::concepts::differentiable_rbf") {
    using num_collect::rbf::concepts::differentiable_rbf;
    using num_collect::rbf::rbfs::differentiated_t;

    SECTION("check RBFs") {
        STATIC_REQUIRE(
            differentiable_rbf<num_collect::rbf::rbfs::gaussian_rbf<double>>);
        STATIC_REQUIRE(differentiable_rbf<
            num_collect::rbf::rbfs::wendland_csrbf<double, 2, 0>>);
        STATIC_REQUIRE_FALSE(differentiable_rbf<differentiated_t<
                num_collect::rbf::rbfs::wendland_csrbf<double, 2, 0>>>);
    }
}

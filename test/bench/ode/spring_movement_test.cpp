...
// NOLINTNEXTLINE
STAT_BENCH_CASE_F(spring_movement_fixture, "ode_rk_spring_movement", "dopri5") {
    STAT_BENCH_MEASURE() {
        using solver_type =
...
// NOLINTNEXTLINE
STAT_BENCH_CASE_F(spring_movement_fixture, "ode_rk_spring_movement", "rodasp") {
    STAT_BENCH_MEASURE() {
        using solver_type =
...
// NOLINTNEXTLINE
STAT_BENCH_CASE_F(
    spring_movement_fixture, "ode_rk_spring_movement", "rodaspr") {
    STAT_BENCH_MEASURE() {
        using solver_type =

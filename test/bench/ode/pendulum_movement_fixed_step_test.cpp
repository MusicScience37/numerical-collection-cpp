...
/*!
 * \file
 * \brief Test of solving ODE of pendulum movement with fixed step sizes.
 */
#include <Eigen/Core>
...
static constexpr std::string_view problem_name =
    "pendulum_movement_problem_fixed_step";
...
#else
static constexpr double end_time = 100.0;
#endif
...
auto main(int argc, char** argv) -> int {
    ...
    bench_one<num_collect::ode::runge_kutta::radau2a7_fixed_step_solver<
        problem_type>>("RadauIIA7", executor);
    bench_one<num_collect::ode::runge_kutta::radau2a9_fixed_step_solver<

...
auto main(int argc, char** argv) -> int {
    ...
    for (const double epsilon : epsilon_list) {
        ...
        bench_one<num_collect::ode::runge_kutta::rkf45_adaptive_step_solver<
            problem_type>>("RKF45", epsilon, executor);
        bench_one<num_collect::ode::runge_kutta::dopri5_adaptive_step_solver<
            problem_type>>("DOPRI5", epsilon, executor);
        bench_one<num_collect::ode::runge_kutta::ark43_erk_adaptive_step_solver<
            problem_type>>("ARK4(3)-ERK", epsilon, executor);
        bench_one<num_collect::ode::runge_kutta::tanaka1_adaptive_step_solver<
            problem_type>>("Tanaka1", epsilon, executor);
        bench_one<num_collect::ode::runge_kutta::tanaka2_adaptive_step_solver<
        ...
        bench_one<num_collect::ode::runge_kutta::
                ark54_esdirk_adaptive_step_solver<problem_type>>(
            "ARK5(4)-ESDIRK", epsilon, executor);
        bench_one<num_collect::ode::runge_kutta::esdirk45_adaptive_step_solver<
            problem_type>>("ESDIRK45c", epsilon, executor);
        bench_one<num_collect::ode::runge_kutta::
                lobatto3c4_adaptive_step_solver<problem_type>>(
            "LobattoIIIC4", epsilon, executor);
        bench_one<num_collect::ode::runge_kutta::
                lobatto3c6_adaptive_step_solver<problem_type>>(
            "LobattoIIIC6", epsilon, executor);
        bench_one<num_collect::ode::runge_kutta::radau2a3_adaptive_step_solver<
            problem_type>>("RadauIIA3", epsilon, executor);
        bench_one<num_collect::ode::runge_kutta::radau2a5_adaptive_step_solver<
            problem_type>>("RadauIIA5", epsilon, executor);

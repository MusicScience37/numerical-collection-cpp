...
class pendulum_movement_fixture : public stat_bench::FixtureBase {
public:
...
// NOLINTNEXTLINE
STAT_BENCH_CASE_F(
    pendulum_movement_fixture, "ode_rk_pendulum_movement", "rkf45") {
    STAT_BENCH_MEASURE() {
        using solver_type =
...
// NOLINTNEXTLINE
STAT_BENCH_CASE_F(
    pendulum_movement_fixture, "ode_rk_pendulum_movement", "dopri5") {
    STAT_BENCH_MEASURE() {
        using solver_type =
...
// NOLINTNEXTLINE
STAT_BENCH_CASE_F(
    pendulum_movement_fixture, "ode_rk_pendulum_movement", "tanaka1") {
    STAT_BENCH_MEASURE() {
        using solver_type =
...
// NOLINTNEXTLINE
STAT_BENCH_CASE_F(
    pendulum_movement_fixture, "ode_rk_pendulum_movement", "tanaka2") {
    STAT_BENCH_MEASURE() {
        using solver_type =
...
// NOLINTNEXTLINE
STAT_BENCH_CASE_F(
    pendulum_movement_fixture, "ode_rk_pendulum_movement", "rodasp") {
    STAT_BENCH_MEASURE() {
        using solver_type =
...
// NOLINTNEXTLINE
STAT_BENCH_CASE_F(
    pendulum_movement_fixture, "ode_rk_pendulum_movement", "rodaspr") {
    STAT_BENCH_MEASURE() {
        using solver_type =
...
// NOLINTNEXTLINE
STAT_BENCH_CASE_F(
    pendulum_movement_fixture, "ode_rk_pendulum_movement", "rk4_auto") {
    STAT_BENCH_MEASURE() {
...
// NOLINTNEXTLINE
STAT_BENCH_CASE_F(
    pendulum_movement_fixture, "ode_rk_pendulum_movement", "avf2_auto") {
    STAT_BENCH_MEASURE() {
        using solver_type =
...
// NOLINTNEXTLINE
STAT_BENCH_CASE_F(
    pendulum_movement_fixture, "ode_rk_pendulum_movement", "avf3_auto") {
    STAT_BENCH_MEASURE() {
        using solver_type =
...
// NOLINTNEXTLINE
STAT_BENCH_CASE_F(
    pendulum_movement_fixture, "ode_rk_pendulum_movement", "avf4_auto") {
    STAT_BENCH_MEASURE() {
        using solver_type =

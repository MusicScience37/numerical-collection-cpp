...
/*!
 * \file
 * \brief Definition of error_udm class.
 */
#pragma once
...
/*!
 * \brief Class of Celero's user defined measurement for errors.
 */
class error_udm final : public celero::UserDefinedMeasurementTemplate<double> {
private:
    /*!
     * \brief Get the name.
     *

...
/*!
 * \file
 * \brief Benchmark of RBF interpolation in 2 dimensions.
 */
#include <cmath>
#include <cstddef>
...
class interpolate_2d_fixture_base : public stat_bench::FixtureBase {
public:
    interpolate_2d_fixture_base() = default;
...
private:
    ...
    num_collect::util::vector<Eigen::Vector2d> evaluation_variables_{};
...
class interpolate_2d_fixture_light : public interpolate_2d_fixture_base {
public:
    interpolate_2d_fixture_light() {
...
class interpolate_2d_fixture_medium : public interpolate_2d_fixture_base {
public:
    interpolate_2d_fixture_medium() {
        add_param<num_collect::index_type>("points")
            ->add(10)
            ->add(20)
            ->add(50)
...
STAT_BENCH_CASE_F(interpolate_2d_fixture_light, "interpolate_2d",

...
/*!
 * \file
 * \brief Implementation of functions to get and set logging configurations.
 */
...
auto get_default_tag_config() -> log_tag_config {
...
auto get_config_of(log_tag_view tag) -> log_tag_config {
    return log_config::instance().get_config_of(tag);
}
